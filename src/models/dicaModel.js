...
export default class DicaModel {
    ...
    async atualizar() {
        return prisma.dica.update({
            where: { id: this.id },
            data: { tipo_pt: this.tipo_pt, tipo_en: this.tipo_en, conteudo_pt: this.conteudo_pt, conteudo_en: this.conteudo_en },
        });
    }
    ...
    static async buscarTodos(filtros = {}) {
        ...
        if (filtros.conteudo_pt) {
            where.conteudo_pt = { contains: filtros.conteudo_pt, mode: 'insensitive' };
        }
