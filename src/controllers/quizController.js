...
export const criar = async (req, res) => {
  try {
    ...
    if (!pergunta_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "pergunta_pt" é obrigatório!' });
    }
    if (!pergunta_en) {
      return res
        .status(400)
        .json({ error: 'O campo "pergunta_en" é obrigatório!' });
    }
    if (!opcaoA_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoA_pt" é obrigatório!' });
    }
    if (!opcaoA_en) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoA_en" é obrigatório!' });
    }
    if (!opcaoB_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoB_pt" é obrigatório!' });
    }
    if (!opcaoB_en) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoB_en" é obrigatório!' });
    }
    if (!opcaoC_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoC_pt" é obrigatório!' });
    }
    if (!opcaoC_en) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoC_en" é obrigatório!' });
    }
    if (!opcaoD_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoD_pt" é obrigatório!' });
    }
    if (!opcaoD_en) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoD_en" é obrigatório!' });
    }
    if (!opcaoE_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoE_pt" é obrigatório!' });
    }
    if (!opcaoE_en) {
      return res
        .status(400)
        .json({ error: 'O campo "opcaoE_en" é obrigatório!' });
    }
    if (!resposta) {
      return res
        .status(400)
        .json({ error: 'O campo "resposta" é obrigatório!' });
    }
    if (!explicacao_pt) {
      return res
        .status(400)
        .json({ error: 'O campo "explicacao_pt" é obrigatório!' });
    }
    if (!explicacao_en) {
      return res
        .status(400)
        .json({ error: 'O campo "explicacao_en" é obrigatório!' });
    }
...
export const atualizar = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({
        message: `O registro "${data.pergunta_pt}" foi atualizado com sucesso!`,
        data,
      });
  } catch (error) {
...
export const deletar = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({
        message: `O registro "${quiz.pergunta_pt}" foi deletado com sucesso!`,
        deletado: quiz,
      });
  } catch (error) {
