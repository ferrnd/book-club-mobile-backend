...
async function main() {
  ...
  await prisma.livro.create({
    data: {
      titulo: "Olhos d'Água",
      capa: "https://raw.githubusercontent.com/ferrnd/book-club-mobile-backend/refs/heads/main/images/bookCover/capa-sub.png",
      ...
      detalhesAutor_en:
        "Conceição Evaristo is one of the most powerful voices in contemporary Brazilian literature. Born in a favela in Belo Horizonte, her career was shaped by the struggle of balancing domestic work with her studies, eventually leading to a PhD in Literature. This life experience forms the foundation of her literary production, which she defines through the concept of escrevivência: a form of writing that is inseparable from life and gives voice to the collective memory of Afro-Brazilian people. In her works, such as the award-winning Olhos D’água, Conceição removes Black people from the position of objects or stereotypes, establishing them as the subjects of their own stories. She explores themes such as structural racism, ancestry, and the resilience of Black women, always balancing the harshness of social reality with deep lyricism. Her writing is an act of resistance that seeks to humanize bodies that have been historically marginalized, transforming pain into literature of high technical and emotional quality.",
      anoPublicacao: 2014,
      genero:
      ...
      resumo:
        "Olhos D’Água, de Conceição Evaristo, reúne contos sobre a vida de mulheres negras no Brasil, abordando temas como racismo, pobreza, violência e resistência. Com uma escrita poética e emocionante, a autora mostra as lutas, sonhos e a força dessas personagens, incentivando a reflexão sobre as injustiças sociais e a importância da ancestralidade e da esperança.",
      resumo_en:
        "Olhos D’Água, by Conceição Evaristo, is a collection of short stories about the lives of Black women in Brazil, addressing themes such as racism, poverty, violence, and resilience. Through poetic and moving writing, the author portrays the struggles, dreams, and strength of these characters, encouraging reflection on social injustice and highlighting the importance of ancestry and hope.",
      contexto:
      ...
      estiloEscrita:
        "Olhos d’Água, de Conceição Evaristo, é marcado pelo conceito de escrevivência, onde a escrita nasce da experiência de vida da mulher negra. O estilo da autora equilibra uma realidade crua (fome, violência e racismo) com um lirismo sensível, utilizando a água como metáfora para a dor (lágrimas) e para a ancestralidade (rios e mar). Sua narrativa tem um ritmo oral, como se estivesse contando histórias ao redor de uma mesa, valorizando a fala popular e a memória. Mais do que denunciar a pobreza, Evaristo humaniza as vítimas da desigualdade, transformando estatísticas em personagens profundos, com medos e desejos. Em suma, é uma literatura de resistência que resgata a dignidade de quem a história oficial tentou apagar.",
      estiloEscrita_en:
        'Olhos d’Água, by Conceição Evaristo, is defined by the concept of escrevivência—a term blending "writing" and "lived experience"—where the prose is born from the life experiences of Black women. The author’s style balances a raw reality (hunger, violence, and racism) with a sensitive lyricism, using water as a metaphor for both pain (tears) and ancestry (rivers and the sea). Her narrative possesses an oral rhythm, as if she were storytelling around a table, honoring popular speech and collective memory. Rather than simply denouncing poverty, Evaristo humanizes the victims of inequality, transforming statistics into profound characters with fears and desires. Ultimately, it is a literature of resistance that restores the dignity of those whom official history has tried to erase.',
      enredo:
        'O enredo de Olhos d’Água é uma coletânea de 15 contos que formam um retrato coletivo da população negra e periférica do Brasil. O fio condutor não é uma única história, mas a "escrevivência": o relato de vidas marcadas pela busca por identidade e pela luta contra a violência, a pobreza e o racismo estrutural. As narrativas variam entre a memória afetiva — como a busca da filha pela cor dos olhos da mãe — e a crueza da realidade urbana, onde personagens enfrentam a morte precoce, o abandono e o preconceito. No centro dessas histórias estão as mulheres, que protagonizam o papel de mães, amantes e sobreviventes, mantendo a dignidade e a ancestralidade vivas em meio a um cenário de opressão. Em suma, o enredo é um mosaico de dor e resistência que humaniza aqueles que a sociedade costuma ignorar.',
      enredo_en:
        "The plot of Olhos d’Água is a collection of 15 short stories that form a collective portrait of Brazil's Black and peripheral populations. The common thread is not a single storyline, but rather 'escrevivência': the chronicling of lives marked by the search for identity and the struggle against violence, poverty, and structural racism. The narratives range from affective memory—such as a daughter’s search for the color of her mother’s eyes—to the harshness of urban reality, where characters face premature death, abandonment, and prejudice. At the center of these stories are women, who take the lead as mothers, lovers, and survivors, keeping dignity and ancestry alive amidst a landscape of oppression. In short, the plot is a mosaic of pain and resilience that humanizes those whom society usually ignores.",
      verossimilhanca:
        "Na obra Olhos d’Água, a verossimilhança é construída pela proximidade com a realidade social brasileira. Conceição Evaristo utiliza uma linguagem simples, narradores próximos das vivências e situações comuns às periferias, o que faz as histórias parecerem reais. Além disso, a ausência de idealização e o foco em experiências coletivas — como racismo, pobreza e violência — reforçam a sensação de que os acontecimentos poderiam acontecer na vida real.",
      verossimilhanca_en:
        "In the work Olhos d’Água, verisimilitude is built through its close connection to Brazilian social reality. Conceição Evaristo uses simple language, narrators closely tied to lived experiences, and situations common in urban peripheries, which makes the stories feel real. In addition, the absence of idealization and the focus on collective experiences—such as racism, poverty, and violence—reinforce the sense that the events could happen in real life.",
      personagens: [
        "Ana Davenga",
        "Ayoluwa",
        "Cida",
      ...
      caracteristicasLiterarias:
        "O livro Olhos d’Água apresenta características literárias marcantes que reforçam seu valor social e estético. A escrita de Conceição Evaristo é simples, mas ao mesmo tempo poética e carregada de sensibilidade, com forte presença de simbolismo, especialmente em elementos como a água e a memória. A autora utiliza o conceito de escrevivência, misturando ficção com experiências reais e coletivas, o que dá autenticidade às narrativas. Os contos focam na realidade social brasileira, abordando temas como racismo, pobreza, fome e violência, e trazem como protagonistas personagens marginalizados, como mulheres negras e pessoas das periferias. Além disso, há o uso de narradores subjetivos e emocionais, que aproximam o leitor, e uma linguagem com traços de oralidade, valorizando a cultura popular. A estrutura também pode apresentar temporalidade não linear, com mistura de passado e presente, geralmente guiada pela memória.",
      caracteristicasLiterarias_en:
        "The book Olhos d’Água presents striking literary characteristics that highlight both its social and aesthetic value. The writing of Conceição Evaristo is simple yet poetic and deeply sensitive, with a strong presence of symbolism, especially in elements such as water and memory. The author uses the concept of escrevivência, blending fiction with real and collective experiences, which gives authenticity to the narratives. The stories focus on Brazilian social reality, addressing themes such as racism, poverty, hunger, and violence, and feature marginalized characters as protagonists, particularly Black women and people from urban peripheries. In addition, the use of subjective and emotional narrators brings the reader closer to the stories, while the language reflects elements of orality, valuing popular culture. The structure may also present a non-linear sense of time, mixing past and present, often guided by memory.",
      conclusao:
  ...
  await prisma.autor.create({
    data: {
      ...
      conquistas_pt:
        "Em 2015, Olhos d'água venceu o Prêmio Jabuti na categoria Contos. Em 2018, recebeu o Prêmio de Literatura do Governo de Minas Gerais pelo conjunto da obra — sendo a primeira escritora negra a conquistar esse prêmio desde sua criação, em 2007. Em 2019, foi eleita Personalidade Literária do Ano também pelo Prêmio Jabuti. Recebeu ainda o título de Intelectual do Ano pela União Brasileira de Escritores e foi convidada para dar palestras em universidades estrangeiras. Em 2024, passou a ocupar uma cadeira na Academia Mineira de Letras. Vale registrar que, em 2021, a escritora não foi eleita para a Academia Brasileira de Letras, apesar do amplo apoio popular, com dois abaixo-assinados e milhares de assinaturas circulando em sua defesa. Em 2025, foi a homenageada da 15ª edição da FLUP (Festa Literária das Periferias), tornando-se a primeira autora viva a receber essa reverência no evento.",
      conquistas_en:
        "In 2015, Olhos d'água won the Jabuti Prize in the Short Stories category. In 2018, she received the Literature Prize from the Government of Minas Gerais for her body of work — becoming the first Black woman writer to win this award since its creation in 2007. In 2019, she was named Literary Personality of the Year, also by the Jabuti Prize. She also received the Intellectual of the Year title from the Brazilian Writers' Union and was invited to give lectures at foreign universities. In 2024, she took a seat at the Academy of Letters of Minas Gerais. It is worth noting that, in 2021, the writer was not elected to the Brazilian Academy of Letters, despite broad popular support, with two petitions and thousands of signatures circulating in her defense. In 2025, she was honored at the 15th edition of FLUP (Literary Festival of the Peripheries), becoming the first living author to receive this tribute at the event.",
      formacao_pt:
        "A trajetória de Conceição Evaristo é, ela mesma, a origem de toda a sua literatura. Nascida em uma favela de Belo Horizonte, filha de dona Joana, lavadeira e passadeira, cresceu com outros oito irmãos. Aos sete anos, foi morar com uma tia para ter melhores condições de estudo. Trabalhou como empregada doméstica e, em 1971, concluiu o curso de magistério. Só conseguiu emprego como professora em 1973, após prestar concurso público, quando se mudou para o Rio de Janeiro. Cursou Letras na UFRJ, fez mestrado em Literatura Comparada na UFF e concluiu o doutorado em 2010. Sua dissertação de mestrado foi 'Literatura negra: uma poética de nossa afro-brasilidade' (PUC-RJ, 1996), trabalho que ela considera fundamental para consolidar o conceito de escrevivência. Em paralelo à carreira literária, contribuiu com publicações acadêmicas na Alemanha, Inglaterra e Estados Unidos.",
      formacao_en:
        "Conceição Evaristo's life journey is, in itself, the origin of all her literature. Born in a favela in Belo Horizonte, daughter of Dona Joana, a washerwoman and ironer, she grew up with eight other siblings. At seven years old, she went to live with an aunt to have better study conditions. She worked as a domestic servant and, in 1971, completed her teaching diploma. She only secured a teaching position in 1973, after passing a civil service exam, when she moved to Rio de Janeiro. She studied Literature at UFRJ, completed a master's degree in Comparative Literature at UFF, and finished her doctorate in 2010. Her master's thesis was 'Black Literature: A Poetics of Our Afro-Brazilianness' (PUC-RJ, 1996), a work she considers essential for consolidating the concept of escrevivência. Alongside her literary career, she contributed academic publications in Germany, England, and the United States.",
      marcos_pt:
        "Estreou na literatura em 1990, publicando poemas e contos na série Cadernos Negros, do Grupo Quilombhoje — coletânea pioneira da literatura afro-brasileira. Principais obras publicadas: Ponciá Vicêncio (2003), Becos da Memória (2006), Poemas da recordação e outros movimentos (2008), Insubmissas lágrimas de mulheres (2011), Olhos d'água (2014) e Histórias de leves enganos e presenças (2016). Ainda publicou Canção para ninar menino grande (2018) e Macabéa, flor de mulungu (2023), que dialoga com A hora da estrela, de Clarice Lispector. Ao todo, conta com obras traduzidas para o inglês, francês, espanhol e árabe. Em julho de 2023, fundou a Casa Escrevivência, um centro cultural no bairro da Saúde (Rio de Janeiro), voltado para preservar seu acervo e promover pesquisa sobre literatura negra.",
      marcos_en:
        "She debuted in literature in 1990, publishing poems and short stories in the Cadernos Negros series by the Quilombhoje Group — a pioneering collection of Afro-Brazilian literature. Main published works: Ponciá Vicêncio (2003), Becos da Memória (2006), Poemas da recordação e outros movimentos (2008), Insubmissas lágrimas de mulheres (2011), Olhos d'água (2014), and Histórias de leves enganos e presenças (2016). She also published Canção para ninar menino grande (2018) and Macabéa, flor de mulungu (2023), which dialogues with A hora da estrela by Clarice Lispector. In total, her works have been translated into English, French, Spanish, and Arabic. In July 2023, she founded Casa Escrevivência, a cultural center in the Saúde neighborhood (Rio de Janeiro), dedicated to preserving her collection and promoting research on Black literature.",
      inspiracao_pt:
        "Na adolescência, suas leituras formadoras incluíam Jorge Amado, José Lins do Rego e Carolina Maria de Jesus; mais tarde, Graciliano Ramos, Guimarães Rosa, Drummond, Manuel Bandeira e poetas negros como Solano Trindade e Abdias do Nascimento. Entre suas referências mais citadas estão Carolina Maria de Jesus, Djamila Ribeiro, Lélia Gonzalez e Angela Davis — pensadoras que, como ela, revolucionaram a narrativa sobre a vida das mulheres negras. A própria Carolina Maria de Jesus ocupa um lugar especial: Conceição coordenou a coleção Cadernos de Carolina (Companhia das Letras, 2021) e a descreve como alguém que 'criou uma tradição literária' ao narrar sua existência de mulher periférica.",
      inspiracao_en:
      ...
      curioso_en:
        "Casa Escrevivência was deliberately inaugurated in the Saúde neighborhood of Rio de Janeiro — a region known as 'Little Africa' — in a gesture loaded with meaning: to be physically anchored in the city's Black memory, near Muhcab and the Pretos Novos museum. The impulse to create it was both practical and poetic: she couldn't stand seeing her books sitting idle on shelves. 'A book on a shelf means nothing. It's just a collection for cockroaches and termites to eat,' she said.",
      estilo_escrita_pt:
  ...
  await prisma.personagem.createMany({
    data: [
      ...
      },
      {
        ...
        contoId: contosData.find(
          (c) => c.titulo_pt === "Quantos filhos Natalina teve?",
        )?.id,
      },
      {
        nome: "Salinda",
  ...
  await prisma.citacao.createMany({
    data: [
      ...
      {
        texto_pt:
          "A mãe só ria, de uma maneira triste e com um sorriso molhado.",
