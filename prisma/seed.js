    ...
    data: [
      {
        ...
        caracteristicas_pt: "Mulher negra de corpo exuberante, 'peitos-maçãs' salientes que provocavam o olhar alheio. Pele negra e presença física marcante — sua corporalidade é descrita como um conjunto de vitalidade e sensualidade que 'explodiam por todo o seu corpo'.",
      ...
      },
      {
        nome: "Maria",
        fotoUrl: "https://raw.githubusercontent.com/ferrnd/book-club-mobile-backend/refs/heads/main/images/characters/maria.png",
        caracteristicas_pt: "Mulher negra e periférica, moradora de favela. Vestimenta simples de quem trabalha como doméstica. Corpo cansado pela rotina do trabalho e pelo peso das longas esperas nos pontos de ônibus — corpo marcado pela invisibilidade social que lhe é imposta.",
        caracteristicas_en: "Black peripheral woman, favela resident. Simple clothing of someone who works as a domestic servant. Body tired from work routine and the weight of long waits at bus stops — a body marked by the social invisibility imposed on her.",
        descricao_pt:
      ...
      },
      {
        ...
        caracteristicas_pt: "Mulher negra periférica cuja aparência está intimamente ligada à sua rotina diária. Corpo que se move na 'corda bamba do tempo' — a 'frágil vara' da existência. Seu cooper (corrida leve) é uma imagem do corpo negro feminino que precisa se mover constantemente para não cair do fio tenso da sobrevivência.",
        caracteristicas_en: "A peripheral Black woman whose appearance is intimately linked to her daily routine. A body that moves on the 'tightrope of time' — the 'fragile rod' of existence. Her cooper (light running) is an image of the Black female body that must constantly move not to fall from the tense thread of survival.",
        descricao_pt:
      ...
      },
      {
        ...
        caracteristicas_pt: "Menina negra pequena, criança da favela com a inocência inscrita no corpo de 'borboleta-menina'. Tem uma irmã gêmea, Naíta. Seu corpo de criança contrasta com o ambiente de violência em que está inserida — os brinquedos espalhados pelo chão são o símbolo de sua infância interrompida.",
        caracteristicas_en: "Small Black girl, favela child with innocence inscribed in her body as a 'butterfly-girl'. She has a twin sister, Naíta. Her child's body contrasts with the violent environment she is inserted into — the toys scattered on the ground are the symbol of her interrupted childhood.",
        descricao_pt:
      ...
      },
      {
        ...
        caracteristicas_pt: "Cinquentona que aparenta ser muito mais jovem. 'Estava inteirinha, apesar de tantos trambolhões e acidentes de percurso em sua vida-estrada.' Corpo que desmentiu o tempo, preservando uma vitalidade que surpreendia a si mesma diante do espelho. Negra, marcada pela beleza que atravessou cinco décadas.",
        caracteristicas_en: "A fifty-year-old woman who appears much younger. 'She was whole, despite so many stumbles and accidents along her life-road.' A body that defied time, preserving a vitality that surprised even herself in the mirror. Black, marked by the beauty that spanned five decades.",
        descricao_pt:
